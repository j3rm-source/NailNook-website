  ...
  return (
    <section style={{ backgroundColor: '#080808', borderTop: '1px solid #1a1a1a', borderBottom: '1px solid #1a1a1a' }}>
      <div className="max-w-5xl mx-auto px-6 py-24">
        <p className="text-center text-xs font-700 uppercase tracking-widest mb-3" style={{ color: '#00d4b8' }}>
          Revenue Calculator
        </p>
        <h2 className="text-4xl md:text-5xl font-800 text-center mb-3" style={{ letterSpacing: '-0.03em' }}>
          Calculate your{' '}
          <span style={{ color: '#00d4b8' }}>hidden losses</span>
        </h2>
          ...
          <div className="space-y-10">
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-2xl font-800" style={{ color: '#00d4b8' }}>{missedCalls}</span>
              </div>
              <input
                type="range"
                min={1} max={50}
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-2xl font-800" style={{ color: '#00d4b8' }}>${jobValue}</span>
              </div>
              <input
                type="range"
          ...
          <div className="rounded-2xl p-8 space-y-6" style={{ backgroundColor: '#0d0d0d', border: '1px solid #1e1e1e' }}>
            <div className="flex items-start justify-between pb-5" style={{ borderBottom: '1px solid #1a1a1a' }}>
              <div>
                ...
                <p className="text-3xl font-800 text-white">{fmt(weeklyLost)}</p>
              </div>
              <div className="text-right">
                <p className="text-xs font-600 uppercase tracking-wider mb-1" style={{ color: '#555' }}>Annual lost revenue</p>
                <p className="text-3xl font-800 text-white">{fmt(annualLost)}</p>
              </div>
            </div>
            <div>
              <p className="text-xs font-600 uppercase tracking-wider mb-2" style={{ color: '#00d4b8' }}>What TradeDesk recovers</p>
              <p className="text-5xl font-800 mb-1" style={{ color: '#00d4b8' }}>{fmt(recovered)}<span className="text-lg font-400 ml-1" style={{ color: '#00a890' }}>/yr</span></p>
