    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 px-4">
      ...
      <div className="relative w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-700 text-white">Start your free trial</h1>
          <p className="text-slate-400 mt-1 text-sm">No credit card required to get started</p>
        </div>
        ...
        <div className="card border-slate-700/60">
          ...
          <div className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link href="/login" className="text-blue-400 hover:text-blue-300 font-500 transition-colors">
              Sign in
            </Link>
          </div>
        </div>
